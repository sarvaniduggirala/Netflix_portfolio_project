-- We are creating a new table, consolidating all non-null cells from multiple columns in the existing table into a 
-- single column, paired with their respective show_id in the netflix_data database.
